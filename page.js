...
function Dqrcode() {
	...
	if($('#destoon_qrcode').length > 0) {
		if($('#destoon_qrcode').html().length < 10) {
			...
			$('#destoon_qrcode').html('<div style="text-align:right;color:#555555;font-size:16px;padding-right:6px;cursor:pointer;">x</div><img src="'+DTPath+'api/qrcode.png.php?auth='+encodeURIComponent(url)+'" width="140" height="140"/><div style="padding:10px 0;font-size:14px;font-weight:bold;color:#555555;">鎵竴鎵紝鐩存帴鍦ㄦ墜鏈轰笂鎵撳紑</div><div style="padding-bottom:20px;color:#999999;">鎺ㄨ崘寰俊銆丵Q鎵竴鎵瓑鎵爜宸ュ叿</div>');
